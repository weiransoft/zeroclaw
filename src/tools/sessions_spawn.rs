...
impl Tool for SessionsSpawnTool {
    ...
    fn description(&self) -> &str {
        "CRITICAL TOOL for orchestrators to delegate work. Spawn a sub-agent to handle a specific task. The sub-agent will complete the task and report results back to you automatically. Use this tool to delegate work instead of completing it yourself."
    }
