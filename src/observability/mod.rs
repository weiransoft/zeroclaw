...
/// 预导入模块 - 用于方便地导入可观测性相关类型
/// 这些类型通过 gateway 模块的 prelude 路径使用
#[allow(unused_imports)]
pub mod prelude {
    pub use crate::observability::alert::{Alert, AlertType, AlertSeverity, AlertRule, AlertManager};
    pub use crate::observability::failure::{FailureAnalyzer, FailurePattern, FailureRecord};
}
